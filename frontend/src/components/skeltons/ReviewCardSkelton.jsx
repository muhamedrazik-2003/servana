  ...
  return (
    <div className={`shrink-0 ${variant === "provider" ? "w-120 h-50" : "w-80 h-60"} rounded-3xl border shadow-sm flex flex-col justify-between `}>
      <div>
        ...
        <Skeleton className={`${variant === "provider" ? "w-110 h-4 mt-6" : "w-70 h-4 mt-8"} m-4  mb-2 rounded-full`} />
        <Skeleton className={`${variant === "provider" ? "w-110 h-4" : "w-70 h-4"}  m-4 my-2 rounded-full`} />
        <Skeleton className={`${variant === "provider" ? "w-110 h-4" : "w-70 h-4"}  m-4 my-2 rounded-full`} />
      </div>
      <div>
