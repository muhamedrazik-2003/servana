    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) border-0 hover:bg-teal-500 aria-disabled:opacity-50 p-0 select-none",
        ...
        today: cn(
          "bg-primary text-background rounded-3xl data-[selected=true]:rounded-lg",
