        ...
        <section className="mt-10 space-y-5 pb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                {recommendedServices?.length > 0
                    ...
                    : <h2 className='md:col-span-2 lg:col-span-4 text-center py-15 text-5xl text-secondary'>Currently no recommended Services<br /> Are Available at the moment</h2>
                }
            </div>
        </section>
    )
