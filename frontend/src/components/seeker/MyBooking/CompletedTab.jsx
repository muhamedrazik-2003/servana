    ...
    <section className={`${userRole === "provider" ? "ml-0 mr-14" : ""}`}>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-100px gap-5'>
        {completedBookings?.length > 0
          ...
          : userRole === "provider"
            ? <h2 className='md:col-span-2 lg:col-span-3 text-center py-15 text-3xl leading-10'>You don’t have any <span className='text-green-500'>completed</span> bookings<br /> at the moment.</h2>
          : <h2 className='md:col-span-2 lg:col-span-3 text-center py-15 text-3xl leading-10'>You don’t have any <span className='text-green-500'>completed</span> bookings<br /> at the moment.</h2>
        }
      </div>
    </section>
