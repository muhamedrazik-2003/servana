...
function FailedTab({ data, userRole }) {
    ...
    return (
        <section className={`${userRole === "provider" ? "ml-0 mr-14" : ""}`}>
          ...
          : <h2 className='md:col-span-2 lg:col-span-3 text-center py-8 text-5xl text-secondary'>You don’t have <br />any <span className='text-red-500'>failed</span> bookings<br /> at the moment.</h2>
                }
            </div>
        </section>
    )
