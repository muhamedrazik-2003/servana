    ...
    return (
        <>
            <div className='flex flex-col lg:flex-row gap-3 items-center'>
                <div className={`${userRole === "provider" ? "w-full md:w-[75%] bg-orange-100 dark:bg-orange-950" : "md:max-w-[70%] w-full md:mx-auto bg-teal-50 dark:bg-teal-950"}  shadow-sm border  md:rounded-4xl cursor-pointer p-2`}>
                    <div className={`relative  text-center flex items-center transition-all duration-300`}>
                        ...
                        <h3 onClick={() => setActiveTab("upcoming")} className={`z-10 ${userRole === "provider" ? "p-1.5" : "p-2.5"} w-[20%] text-xs md:text-base ${activeTab === 'upcoming' ? "text-background" : 'text-foreground'}`} >{userRole === "provider" ? "Requests" : "Pending"}</h3>
