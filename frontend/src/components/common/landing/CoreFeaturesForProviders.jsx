...
function CoreFeaturesForProviders() {
    ...
    return (
        <section id='provider-features' className='flex flex-col lg:flex-row items-center bg-amber-100 dark:bg-amber-950 p-6 lg:p-10 mx-5 lg:mx-20 mb-[92px] lg:mb-[250px] rounded-4xl'>
