...
function ServiceCategory({ format }) {
    ...
    return (
        <section id='categories' className='mx-0 pl-[32px] lg:pl-[100px]'>
            <div className='flex justify-between items-center pr-8 mb-[52px]'>
                <div>
                    <h2 className={`max-w-[600px] ${format === "seeker" && "text-4xl mb-2"}`}>{format === "seeker" ? "Popular Services Near You" : "Services That Simplify Everyday Life."}</h2>
                ...
                <Button variant={'outline'} className={'border'}>View More</Button>
            </div>
