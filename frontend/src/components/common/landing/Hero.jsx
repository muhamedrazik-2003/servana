...
function Hero() {
    return (
        <section className='relative max-w-[650px] mx-auto px-6 md:px-0 pt-[60px] md:pt-[100px] overflow-x-hidden md:overflow-x-visible'>
            <h1 className='text-[clamp(2.8rem,10vw,80px)] leading-13  md:leading-20'>Where Services Meet Simplicity</h1>
