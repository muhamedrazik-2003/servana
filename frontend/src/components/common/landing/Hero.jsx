...
function Hero() {
    return (
        <section className='relative max-w-[650px] mx-auto px-6 md:px-0 pt-[50px] md:pt-[100px] overflow-x-hidden md:overflow-x-visible'>
            ...
            <img className='size-50 lg:size-90 absolute top-62 lg:top-24 left-[-8%] lg:left-[-48%] z-[-1]' src={seekerImage} alt="image of a person using laptop" />
            <img className='size-50 lg:size-90 absolute top-62 lg:top-24 right-[-6%] lg:right-[-45%] z-[-1]' src={providerImage} alt="" />
