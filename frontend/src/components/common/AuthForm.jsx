        ...
        <div className="flex flex-col items-center gap-6">
            {
                (formType === "register" && registerAs === null)
                    ? <div className=' w-65 flex flex-col items-center justify-center gap-3'>
                        <Button
                            onClick={() => setRegisterAs("seeker")}
                            variant={'outline'} size={'lg'}
                            className={'w-full h-30 border bg-teal-100 shadow-xl hover:bg-secondary'}>
                        ...
                        <Button
                            ...
                            variant={'outline'} size={'lg'}
                            className={'w-full h-30 border bg-amber-100 shadow-xl'}>
